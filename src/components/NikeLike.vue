<template>
  <div id="nike-like">
    <header id="nike__header">
      <h1 class="app__ttl">Nike ID Like</h1>
    </header>
    <main id="wrapper">
...
export default {
  ...
  methods: {
    ...
    dataSave() {
      ...
      if(colorList) {
        this.colorLists.push(colorList);
        const jsonData = JSON.stringify(this.colorLists);
        localStorage.setItem('shoes', jsonData);
        this.count++;
      }
    },
    dataClear() {
